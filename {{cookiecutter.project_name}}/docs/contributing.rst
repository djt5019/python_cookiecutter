...
`Pull requests <https://github.com/djt5019/{{cookiecutter.project_name}}/pulls>`_ or `Github issues <https://github.com/djt5019/{{cookiecutter.project_name}}/issues>`_ are always welcome.  If you want to contribute a patch please do the following.
